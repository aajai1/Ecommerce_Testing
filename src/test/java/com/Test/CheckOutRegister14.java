...
public class CheckOutRegister14 {
	...
	public static void products8() throws InterruptedException  {
		...
		Assert.assertTrue(signupElement.isDisplayed(), "signupElement is not displayed");
		 ...
		 WebElement nmae=LocatorsForElement.XpathLocator(driver, "//input[@placeholder='Name']");
		Assert.assertTrue(nmae.isDisplayed(), "Nmaeis n");
		//System.out.println(name.getDomAttribute("value"));
		//wait.until(ExpectedConditions.elementToBeClickable(name));
	
		LocatorsForElement.XpathLocator(driver, "//input[@data-qa='signup-email']").sendKeys("yourname@gmail.com");
